...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    'ar_SA': {
      ...
      'filters_coming_soon': 'الفلاتر قريباً',
   ...
   'listing_action': 'أرغب في...',
      ...
      'email_change_security_notice': 'تغيير بريدك الإلكتروني يتطلب تأكيداً. ستستقبل رمزاً مكوناً من 6 أرقام في عنوان بريدك الجديد لتأكيد التغيير.',
