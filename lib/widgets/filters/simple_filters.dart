...
class SimpleFilters extends StatelessWidget {
            ...
            children: [
              ...
              Expanded(
                ...
                child: _buildFilterDropdown(
                  ...
                  onTap: () => _showLocationFilter(context, filterController, themeController),
              ...
              Expanded(
                ...
                child: _buildFilterDropdown(
                  ...
                  onTap: () => _showPriceFilter(context, filterController, themeController),
                  themeController: themeController,
                ),
              ),
              const SizedBox(width: 8),
              ...
              Expanded(
                ...
                child: _buildFilterDropdown(
                  ...
                  icon: Icons.sort,
                  onTap: () => _showSortFilter(context, filterController, themeController),
                  themeController: themeController,
                ),
              ),
            ],
  ...
  void _showLocationFilter(BuildContext context, FilterController filterController, ThemeController themeController) {
    showModalBottomSheet(
      context: context,
      backgroundColor: themeController.isDarkMode.value ? Colors.grey[850] : Colors.white,
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Cities list
            ...filterController.cities.map((city) => ListTile(
  ...
  void _showPriceFilter(BuildContext context, FilterController filterController, ThemeController themeController) {
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  color: themeController.isDarkMode.value ? Colors.grey[300] : Colors.grey[700],
                ),
              ),
              Slider(
                value: minPrice,
                ...
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () {
                        filterController.minPrice.value = minPrice > 0 ? minPrice : null;
                        filterController.maxPrice.value = maxPrice < 1000000 ? maxPrice : null;
                        Navigator.pop(context);
                        onFiltersChanged();
                      },
                      child: Text('apply'.tr),
  ...
  void _showSortFilter(BuildContext context, FilterController filterController, ThemeController themeController) {
    showModalBottomSheet(
      context: context,
      backgroundColor: themeController.isDarkMode.value ? Colors.grey[850] : Colors.white,
      shape: const RoundedRectangleBorder(
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ...filterController.sortOptions.map((sortOption) => ListTile(
              leading: Icon(_getSortIcon(sortOption)),
              title: Text(filterController.getTranslatedSortOption(sortOption)),
              onTap: () {
