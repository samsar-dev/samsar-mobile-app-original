...
const String _baseUrl =
    "https://samsar-backend-production.up.railway.app"; // Production server
...
const String sendEmailChangeVerificationRoute =
    "$_baseUrl/api/auth/send-email-change-verification";

//post route to change email with verification code body requires verificationCode (protected)
const String changeEmailWithVerificationRoute =
    "$_baseUrl/api/auth/change-email-with-verification";
...
const String sendPasswordChangeVerificationRoute =
    "$_baseUrl/api/auth/send-password-change-verification";
...
dynamic individualListingDetailsRoute(String id) =>
    "$_baseUrl/api/listings/public/$id";

//post route to add listing into favourites and it is protected route so it required access token
dynamic addListingToFavouriteRoute(String listingId) =>
    "$_baseUrl/api/listings/saved/$listingId";
...
dynamic removeFavouriteListingRoute(String listingId) =>
    "$_baseUrl/api/listings/saved/$listingId";
...
dynamic deleteConversationRoute(String conversationId) =>
    "$_baseUrl/api/messages/conversations/$conversationId";
...
const String sendListingMessageRoute =
    "$_baseUrl/api/messages/listings/messages";

// Get all messages in a conversation by ID (protected)
dynamic getMessagesRoute(String conversationId) =>
    "$_baseUrl/api/messages/$conversationId";

//Delete a specific message by ID (protected)
dynamic deleteMessageRoute(String messageId) =>
