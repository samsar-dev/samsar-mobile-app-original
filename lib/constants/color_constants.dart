...
// Adaptive Colors
Color get whiteColor => Get.isDarkMode ? const Color(0xFF121212) : const Color(0xFFFFFFFF);
Color get blackColor => Get.isDarkMode ? const Color(0xFFFFFFFF) : const Color(0xFF000000);
Color get greyColor => Get.isDarkMode ? const Color(0xFFB0B0B0) : const Color(0xFF676C78);
Color get cardColor => Get.isDarkMode ? const Color(0xFF1F1F1F) : const Color(0xFFFFFFFF);
