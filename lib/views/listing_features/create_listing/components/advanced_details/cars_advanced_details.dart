...
class _CarsAdvancedDetailsState extends State<CarsAdvancedDetails> {
  ...
  void initState() {
    ...
    previousOwnersController.text = _listingInputController.previousOwners.value > 0
        ? _listingInputController.previousOwners.value.toString()
        : '';
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Fuel Type - CRITICAL for Syrian market
          ...
          // Transmission - ESSENTIAL for Syrian drivers
          BuildInputWithOptions(
          ...
          // Body Type - Important for family/usage needs
          BuildInputWithOptions(
            title: 'body_type'.tr,
          ...
          // Drive Type - Important for Syrian road conditions
          BuildInputWithOptions(
            title: 'drive_type'.tr,
          ...
          // Mileage - Critical for used car evaluation
          BuildInput(
            title: 'mileage'.tr,
          ...
          // Color - Important for resale value
          Text(
            'color'.tr,
            style: TextStyle(
              fontSize: 16,
          ...
          // Import Status - ESSENTIAL for Syrian market
          BuildInputWithOptions(
