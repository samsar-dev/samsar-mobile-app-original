...
class ApartmentsFeatures extends StatefulWidget {
  const ApartmentsFeatures({super.key});

  @override
  State<ApartmentsFeatures> createState() => _ApartmentsFeaturesState();
}

class _ApartmentsFeaturesState extends State<ApartmentsFeatures> {
