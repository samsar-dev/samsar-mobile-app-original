...
class ConstructionsFeatures extends StatefulWidget {
  const ConstructionsFeatures({super.key});

  @override
  State<ConstructionsFeatures> createState() => _ConstructionsFeaturesState();
}

class _ConstructionsFeaturesState extends State<ConstructionsFeatures> {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              'construction_vehicle_features'.tr,
              style: TextStyle(
