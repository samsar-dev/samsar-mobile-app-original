...
class AdvanceListingOptionsRealEstate extends StatefulWidget {
  ...
  @override
  State<AdvanceListingOptionsRealEstate> createState() =>
      _AdvanceListingOptionsRealEstateState();
}

class _AdvanceListingOptionsRealEstateState
    extends State<AdvanceListingOptionsRealEstate> {
  int currentStep = 0;
  ...
  final TextEditingController foundationTypeController =
      TextEditingController();
  final TextEditingController exteriorFeaturesController =
      TextEditingController();
  ...
  final TextEditingController smartHomeFeaturesController =
      TextEditingController();
  final TextEditingController securityFeaturesController =
      TextEditingController();
  final TextEditingController furnishedController = TextEditingController();
  final TextEditingController includedAppliancesController =
      TextEditingController();
  final TextEditingController accessiblityFeaturesController =
      TextEditingController();
  final TextEditingController storageFeaturesController =
      TextEditingController();
  ...
  final TextEditingController communityFeaturesController =
      TextEditingController();
  ...
  final TextEditingController outdoorFeaturesController =
      TextEditingController();
          ...
          children: [
            ...
            AnimatedInputWrapper(
              ...
              child: BuildInputWithOptions(
                ...
                options: ["MUNCIPAL", "WELL", "SHARED WELL", "CISTERN"],
              ),
            ),
