...
class _HomeViewState extends State<HomeView> with PerformanceOptimizedWidget {
  ...
  void _showLoginPrompt(int tabIndex) {
    ...
    final tabName = tabKeys[tabIndex].tr;
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(
              'login_prompt'.trParams({'tabName': tabName}),
              style: TextStyle(fontSize: 16),
            ),
            SizedBox(height: 12),
            Text(
              'login_prompt_benefits_title'.tr,
              style: TextStyle(fontWeight: FontWeight.bold),
            ),
            SizedBox(height: 8),
            ...[
                  'login_benefit_save_favorites'.tr,
                  'login_benefit_manage_listings'.tr,
                  'login_benefit_chat'.tr,
                  'login_benefit_recommendations'.tr,
                ]
                .map(
                  (benefit) => Padding(
    ...
    return Obx(() {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed:
                        _locationController.errorMessage.value.contains(
                          "permanently denied",
                        )
                        ? () {
      ...
      return Scaffold(
        backgroundColor: _themeController.isDarkMode.value
            ? Colors.grey[900]
            : Colors.white,
        body: IndexedStack(index: _currIndex, children: _buildPages()),
...
class _HomePageContentState extends State<_HomePageContent> {
  ...
  Future<void> _onRefresh() async {
    ...
    if (selectedMainCategory != null) {
      listingController.setCategory(selectedMainCategory!.toUpperCase());
    }
